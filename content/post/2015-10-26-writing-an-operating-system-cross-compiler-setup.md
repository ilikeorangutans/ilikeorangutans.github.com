...
description: Been toying with writing my own operating system kernel. Here are some
  notes on setting up the gcc cross compiler.
tags:
- Kernel
- C
- GCC
...
url: /2015/10/26/writing-an-operating-system-cross-compiler-setup/
---
